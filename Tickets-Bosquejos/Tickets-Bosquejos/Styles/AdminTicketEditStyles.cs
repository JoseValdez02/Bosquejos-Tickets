...
{
    public static class AdminTicketEditStyles
    {

        public static Color Grid;
        public static Color Border1;
        public static Color Border2;
        ...
        private static readonly Color Border1M = Color.FromRgb(139, 63, 60);
        private static readonly Color Border2M = Color.FromRgb(139, 63, 60);
        ...
        private static readonly Color Border1J = Color.FromRgb(38, 97, 156);
        private static readonly Color Border2J = Color.FromRgb(38, 97, 156);
        ...
        private static readonly Color Border1S = Color.FromRgb(82, 183, 136);
        private static readonly Color Button2S = Color.FromRgb(82, 183, 136);
